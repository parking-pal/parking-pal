...
//    console.log("homeowner.js  app.post('/homeowner' 1", req.body, user_id);
    ...
    models.ParkingSpot.findOne({ where: {address: req.body.address} }).then(function(spotExists) {
// spotExists will be the first entry of the ParkingSpots table with address == req.body.address || null
      ...
      {
        var data = { spotExists: spotExists.address };
        console.log("exists entry failed", data);
